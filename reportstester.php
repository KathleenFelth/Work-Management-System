     ...
     
     {
      ...
      class MYPDF extends TCPDF {
          ...
          public function Header() {
              ...
              //heading
              $this->Cell(0, 15, 'Month end report for Employee progress', 0, false, 'C', 0, '', 0, false, 'M', 'M');
              $tDate=date('F j, Y');
              //positioning
              $this->SetY(+15);
      ...
      <table border="1" cellspacing="0" cellpadding="5">  
           <tr>  
                ...
                <th width="10%">No. of tasks for the month</th>                
           </tr>  
      ';  
      $content .= fetch_data();  
      $content .= '</table>';  
      $obj_pdf->writeHTML($content);  
      $obj_pdf->Output('Monthly report.pdf', 'I');  
 }  
