...
<a href="adminmain.php?">
    ...
    <div class="container">
        ...
        <form method="post">
            ...
            <button type="submit" name="change" class="button">Reset</button>
          ...
          include("dbcon.php");
            ...
            $sql = "SELECT * FROM `users` WHERE eid = '" . $_SESSION['login_admin'] . "'";
            ...
            if (password_verify($oldpassword, $row->password))
            {
                ...
                {
                    // Change password
                    $sql = "UPDATE `users` SET `password` = '" . password_hash($newpassword, PASSWORD_DEFAULT) . "' WHERE `eid` = '" . $_SESSION['login_admin'] . "'";
