...
<html lang = "en">
 ...
 <a href="empmain.php?">
        ...
        include("dbcon.php");	
            ...
            <span class ="password"> <a href = "empchangepassword.php"> Want to change your password?</a> </span>
            <?php
        } ?>
        ...
        <?php
            ...
            if(isset($_POST["submit"]))
            {
              ...
              $stmt = $conn->prepare("update users set dob = ?,email = ?,address = ?,number = ?,position = ? where eid='$_SESSION[login_employee]';"); // update query
